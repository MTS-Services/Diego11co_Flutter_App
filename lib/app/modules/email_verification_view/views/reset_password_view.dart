...
class ResetPasswordView extends GetView<EmailVerificationViewController> {
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 10.h),
                            _buildAlignRichText(context , 'Nuova password'),
                            SizedBox(height: 15.h),
                            TextFormField(
                            ...
                            SizedBox(height: 15.h,),
                            _buildAlignRichText(context , 'Conferma password'),
                            SizedBox(height: 15.h,),
                            TextFormField(
                              controller: passwordController,
                              decoration: InputDecoration(
  ...
  Align _buildAlignRichText(BuildContext context , String text) {
    return Align(
      alignment: Alignment.topLeft,
      child: RichText(
        text: TextSpan(
